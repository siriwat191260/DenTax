    ...
    ? [
        { label: "รายได้รวม", value: fmtTHB(result.grossIncome), bold: false },
        {
          label:
            ...
            "หักค่าใช้จ่าย",
          value: `− ${fmtTHB(result.expenseDeduction)}`,
          bold: false,
        },
        {
          label: "รายได้หลังหักค่าใช้จ่าย",
          value: fmtTHB(result.netAfterExpense),
          bold: false,
        },
        {
          label: "ค่าลดหย่อนรวม",
          value: `− ${fmtTHB(result.totalDeductions)}`,
          bold: false,
        },
          ...
          <Card>
            ...
            <div className="space-y-2">
              {INCOME_TYPES.map((t) => (
                ...
                >
                  <p
                    className={`text-xs font-medium ${incomeType === t.value ? "text-teal-700" : "text-gray-700"}`}
                  >
                    {t.title}
                  </p>
                  <p
                    className={`text-xs mt-0.5 ${incomeType === t.value ? "text-teal-600" : "text-gray-400"}`}
                  >
                    {t.sub}
                  </p>
                </button>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                },
                {
                  ...
                  note: "ไม่เกิน 100,000",
                },
                {
                  name: "deductHealthIns",
                  label: "ประกันสุขภาพ",
                  note: "ไม่เกิน 25,000",
                },
          ...
          <Card>
            ...
            <div className="space-y-1">
              {TAX_BRACKETS.map((b, i) => {
                const isActive =
                  result && result.bracket === i && result.netIncome > 0;
                const maxLabel =
          ...
          <Card>
                ...
                <>
                  <div className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-xs text-teal-700 mt-0.5">
                      กรกฎาคม – กันยายน ทุกปี
                    </p>
                    <p className="text-xs text-gray-500">
                      รายได้ มกราคม–มิถุนายน
                    </p>
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-xs text-teal-700 mt-0.5">
                      มกราคม – มีนาคม ปีถัดไป
                    </p>
                    <p className="text-xs text-gray-500">
                      รายได้รวมทั้งปี หักภาษีครึ่งปีที่จ่ายแล้ว
                    </p>
                  </div>
                </>
              ) : (
            ...
            <p className="text-xs text-gray-400 mt-3">
              * ตัวเลขนี้เป็นการประมาณการเบื้องต้นเท่านั้น
              แนะนำให้ปรึกษานักบัญชีหรือสรรพากร
            </p>
          </Card>
        </div>
      </div>
